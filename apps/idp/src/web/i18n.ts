...
const resources = {
  en: {
    translation: {
      ...
      errorRegisterFailed: "Failed to register account",
  ...
  no: {
    translation: {
      ...
      successSignIn: "Vellykket innlogging",
      successSignUp: "Kontoen ble opprettet",
      errorInvalidCredentials: "Ugyldig e-postadresse eller passord",
      errorRegisterFailed: "Kunne ikke opprette konto",
      errorUnexpected: "En uventet feil oppstod",
    },
  },
};
