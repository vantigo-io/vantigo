...
namespace Vantigo.Identity.Database.Accounts.Migrations
{
    ...
    [Migration("20260812083411_AddAuthorizationRbacV2")]
    partial class AddAuthorizationRbacV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vantigo.Identity.Database.Accounts.RoleDelegationBoundary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("StewardedRoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("stewarded_role_id");

                    b.HasKey("Id")
                        .HasName("pk_role_delegation_boundaries");

                    b.HasIndex("StewardedRoleId");

                    b.HasIndex("StewardUserId", "PermissionKey")
                        .HasDatabaseName("ix_role_delegation_boundaries_steward_permission");

                    b.ToTable("role_delegation_boundaries", "identity");
                });
            ...
            modelBuilder.Entity("Vantigo.Identity.Database.Accounts.RoleDelegationBoundary", b =>
                {
                    b.HasOne("Vantigo.Identity.Database.Accounts.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("StewardUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_delegation_boundaries_steward_user_id");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", null)
                        .WithMany()
                        .HasForeignKey("StewardedRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_role_delegation_boundaries_stewarded_role_id");
                });
