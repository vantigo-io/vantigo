...
namespace Vantigo.Identity.Database.Accounts.Migrations
{
    ...
    [Migration("20260813114948_StaticScimIsolationAndStatusUpsert")]
    partial class StaticScimIsolationAndStatusUpsert
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vantigo.Identity.Database.Accounts.ScimConnection", b =>
                {
                    ...
                    b.HasIndex("FederationConnectionId")
                        ...
                        .HasFilter("federation_connection_id IS NOT NULL");

                    b.HasIndex("IsStatic")
                        .IsUnique()
                        .HasDatabaseName("ux_scim_connections_static")
                        .HasFilter("is_static = true");
