...
namespace Vantigo.Identity.Database.Accounts.Migrations
{
    ...
    [Migration("20260812204939_FederationConnectionsAndAccessGroups")]
    partial class FederationConnectionsAndAccessGroups
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vantigo.Identity.Database.Accounts.AccessGroup", b =>
                {
                    ...
                    b.HasIndex("ExternalId")
                        .IsUnique()
                        .HasDatabaseName("ux_access_groups_external_id")
