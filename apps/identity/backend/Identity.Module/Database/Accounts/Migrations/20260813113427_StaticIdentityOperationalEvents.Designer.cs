...
namespace Vantigo.Identity.Database.Accounts.Migrations
{
    ...
    [Migration("20260813113427_StaticIdentityOperationalEvents")]
    partial class StaticIdentityOperationalEvents
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vantigo.Identity.Database.Accounts.OperationalEvent", b =>
                {
                    ...
                    b.HasIndex("Kind")
                        .HasDatabaseName("ix_operational_events_kind");

                    b.HasIndex("Kind", "OccurredAt")
                        .HasDatabaseName("ix_operational_events_kind_occurred_at");
