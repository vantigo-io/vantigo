...
const en = {
  ...
  appCrashBody: "The application could not start. Reload the page; if this keeps happening, contact support.",
...
const nb: { [Key in keyof typeof en]: string } = {
  ...
  errorReload: "Last inn siden på nytt",
  appCrashBody: "Applikasjonen kunne ikke starte. Last inn siden på nytt; kontakt brukerstøtte om det fortsetter.",
