...
public sealed class ContactsEndpointsTests
{
    ...
    {
        var response = await _client.PostAsJsonAsync("/api/v1/customers/contacts", request);
    ...
    {
        var response = await _client.PostAsJsonAsync("/api/v1/customers/contacts", new
        {
            firstName = "Anders",
            lastName = "Refsdal",
            middleName = "Bernhard",
        ...
        Assert.Equal($"/api/v1/customers/contacts/{contact.Id}", response.Headers.Location?.AbsolutePath);
    }
    ...
    public async Task CreateContact_WithNamesOnly_LeavesOptionalFieldsNull()
    {
        ...
        var fetched = await _client.GetFromJsonAsync<Contact>($"/api/v1/customers/contacts/{contact.Id}");
    ...
    public async Task UpdateContact_ReplacesAllFieldsAndClearsBlankOptionals()
    {
        ...
        var response = await _client.PutAsJsonAsync($"/api/v1/customers/contacts/{contact.Id}", new
        {
            firstName = "Ola",
    ...
    {
        var response = await _client.PutAsJsonAsync("/api/v1/customers/contacts/999999", new
        {
            firstName = "Ghost",
            lastName = "Contact",
        });
    ...
    public async Task DeleteContact_RemovesContactAndItsAssociations()
    {
        ...
        var response = await _client.DeleteAsync($"/api/v1/customers/contacts/{contact.Id}");

        Assert.Equal(HttpStatusCode.NoContent, response.StatusCode);
        Assert.Equal(HttpStatusCode.NotFound, (await _client.GetAsync($"/api/v1/customers/contacts/{contact.Id}")).StatusCode);
    ...
    {
        var response = await _client.DeleteAsync("/api/v1/customers/contacts/999999");
    ...
    public async Task GetContacts_Search_MatchesNamePartsPhoneAndEmail()
    {
        ...
        var byFirstName = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=searchable");
        var byMiddleName = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=findme");
        var byPhone = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=99%2088%2077");
        var byEmail = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=searchable%40contactsen");
        var noMatch = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=no-such-contact");
    ...
    public async Task GetContacts_Search_MatchesFullNamesAcrossNameParts()
    {
        ...
        var byFullName = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=fullname%20matchsen");
        var byReversedOrder = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=matchsen%20fullname");
        var byFirstAndMiddle = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=fullname%20bernhard");
        var byPartialTerms = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=full%20match");
        var withWrongTerm = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=fullname%20nomatch");
    ...
    public async Task GetContacts_DefaultSort_OrdersByFirstNameThenLastName()
    {
        ...
        var response = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=Sorttest");
    ...
    public async Task GetContacts_ReturnsCustomerCountAndSingleCustomerName()
    {
        ...
        var response = await _client.GetFromJsonAsync<ContactList>("/api/v1/customers/contacts?search=Countless");
    ...
    public async Task DetachContact_RemovesAssociationButKeepsContact()
    {
        ...
        var stillThere = await _client.GetAsync($"/api/v1/customers/contacts/{contact.Id}");
    ...
    public async Task GetContactCustomers_ReturnsAssociationsSortedByCustomerName()
    {
        ...
        var response = await _client.GetFromJsonAsync<ContactCustomerList>($"/api/v1/customers/contacts/{contact.Id}/customers");
    ...
    {
        var response = await _client.GetAsync("/api/v1/customers/contacts/999999/customers");
