...
internal static class AuthRateLimitingServiceCollectionExtensions
{
    internal static IServiceCollection AddAuthenticationRateLimiting(this IServiceCollection services)
    {
