...
{
    internal static IServiceCollection AddCustomerIdentity(
    ...
    internal static IServiceCollection AddCustomerAuthorization(this IServiceCollection services)
    {
    ...
    internal static IServiceCollection AddCustomerAntiforgery(
        this IServiceCollection services,
        IHostEnvironment environment)
    {
