...
SELECT id, code, name, description, customer_id, status, start_date, end_date, billing_type, currency, fixed_price_amount, budget_hours, budget_amount, revision, created_by_user_id, created_at, updated_at, default_bill_rate FROM projects.projects WHERE id = $1 FOR NO KEY UPDATE
`
