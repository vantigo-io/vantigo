...
WITH entry AS (
    INSERT INTO customers.customers_timeline_entries (
        ...
        @summary::text, @note::text, @source_url, 1, 1, 'active', 'unattributed', 'Unattributed',
...
INSERT INTO customers.customers_timeline_entries_revisions (
    ...
    @current_revision::int, @state::text, @actor_kind::text, @actor_display::text, @created_at::timestamptz,
