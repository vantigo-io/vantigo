...
public sealed class WorkforceOidcOptionsTests
{
    ...
    public void MissingRequiredValues_DisablesOidcEvenWhenOptionalValuesArePresent()
    {
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Authentication:Oidc:CallbackPath"] = "/auth/oidc/company-callback",
            })
            .Build();
    ...
    [Theory]
    [InlineData("/auth/providers")]
    [InlineData("/auth/oidc/challenge")]
    ...
    private sealed class HostEnvironment : IHostEnvironment
    {
        ...
        public string ApplicationName { get; set; } = "Vantigo.Products.Api.Tests";
...
public sealed class WorkforceOidcRoutingTests
{
    ...
    {
        await using var factory = new FreshProductsApiFactory { EnableWorkforceOidc = true };
