...
namespace Vantigo.Products.Api.Database.Products.Migrations
{
    ...
    [Migration("20260810085851_AddCatalogFields")]
    partial class AddCatalogFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Domain.Products.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Domain.Products.Product", b =>
                {
                    b.HasOne("Vantigo.Products.Api.Domain.Products.ProductCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Domain.Products.ProductCategory", b =>
                {
                    b.HasOne("Vantigo.Products.Api.Domain.Products.ProductCategory", null)
                        .WithMany()
