...
namespace Vantigo.Products.Api.Database.Accounts.Migrations
{
    ...
    [Migration("20260804120000_AddInvitations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Database.Accounts.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Database.Accounts.BootstrapState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Vantigo.Products.Api.Database.Accounts.Invitation", b =>
                {
                    ...
                    b.Property<string>("NormalizedEmail").IsRequired().HasMaxLength(256).HasColumnType("character varying(256)").HasColumnName("normalized_email");
                    b.Property<string>("Role").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)").HasColumnName("role");
                    b.Property<string>("DisplayName").HasMaxLength(200).HasColumnType("character varying(200)").HasColumnName("display_name");
                    ...
                    b.HasIndex("TokenHash").IsUnique().HasDatabaseName("ux_invitations_token_hash");
                    b.HasIndex("NormalizedEmail")
                        .IsUnique()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Vantigo.Products.Api.Database.Accounts.ApplicationUser", null)
                        .WithMany()
