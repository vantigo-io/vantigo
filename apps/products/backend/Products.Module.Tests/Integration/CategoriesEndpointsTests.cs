...
public sealed class CategoriesEndpointsTests
{
    ...
    public CategoriesEndpointsTests(ProductsModuleFactory factory)
    {
    ...
    public async Task CreateCategory_AsRootAndSubcategory_ReturnsCreatedWithLocation()
    {
        ...
        var childResponse = await _client.PostAsJsonAsync("/api/v1/products/categories", new
        {
            name = Name("child"),
            parentId = root.Id,
        });
        ...
        Assert.Equal($"/api/v1/products/categories/{child.Id}", childResponse.Headers.Location?.AbsolutePath);
    }
    ...
    public async Task GetCategories_ReturnsFlatListIncludingCreated()
    {
        ...
        var categories = await _client.GetFromJsonAsync<List<Category>>("/api/v1/products/categories");
    ...
    {
        var response = await _client.PostAsJsonAsync("/api/v1/products/categories", new { name = "  " });
    ...
    {
        var response = await _client.PostAsJsonAsync("/api/v1/products/categories", new
        {
            name = Name("orphan"),
            parentId = 999999,
        });
    ...
    {
        var name = Name("dup");
        var first = await _client.PostAsJsonAsync("/api/v1/products/categories", new { name });
        Assert.Equal(HttpStatusCode.Created, first.StatusCode);

        var second = await _client.PostAsJsonAsync("/api/v1/products/categories", new { name });
    ...
    public async Task UpdateCategory_RenamesAndReparents()
    {
        ...
        var response = await _client.PutAsJsonAsync($"/api/v1/products/categories/{child.Id}", new
        {
            name = newName,
            parentId = other.Id,
        });
    ...
    public async Task UpdateCategory_MovingUnderDescendant_ReturnsConflict()
    {
        ...
        var response = await _client.PutAsJsonAsync($"/api/v1/products/categories/{root.Id}", new
        {
            name = root.Name,
    ...
    public async Task UpdateCategory_UnderItself_ReturnsFieldError()
    {
        ...
        var response = await _client.PutAsJsonAsync($"/api/v1/products/categories/{category.Id}", new
        {
            name = category.Name,
    ...
    public async Task DeleteCategory_WithChildren_ReturnsConflict()
    {
        ...
        var response = await _client.DeleteAsync($"/api/v1/products/categories/{root.Id}");
    ...
    public async Task DeleteCategory_WithAssignedProducts_ReturnsConflict()
    {
        ...
        var response = await _client.DeleteAsync($"/api/v1/products/categories/{category.Id}");
    ...
    public async Task DeleteCategory_WithoutChildrenOrProducts_ReturnsNoContent()
    {
        ...
        var fetch = await _client.GetAsync($"/api/v1/products/categories/{category.Id}");
    ...
    {
        var response = await _client.DeleteAsync("/api/v1/products/categories/999999");
